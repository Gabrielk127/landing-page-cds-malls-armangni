...
const Header: React.FC = () => {
  ...
  "
              >
                ...
                Em Seu{" "}
                <span className="text-custom-text-title">Próprio Terreno!</span>
                <br /> Obras Personalizadas Para o{" "}
                <span className="text-custom-text-title">Locatário</span>
              </h1>
              <p
            ...
            "
              >
                Vou mostrar como você pode escalar o faturamento de seu negócio
                sem precisar investir seus próprios recursos. Existe uma maneira
                mais inteligente e eficiente para alcançar esse objetivo.
              </p>
            </div>
