import { DollarSign, Store, TrendingUp, User } from "lucide-react";
          ...
          <div className="mx-auto">
            <h2
              className="text-lg text-center font-bold pb-4 pt-8 flex flex-col items-center justify-center
                  ...
                  "
            >
              <Store className="w-8 h-8 md:w-12 md:h-12 mr-2 text-custom-icons" />
