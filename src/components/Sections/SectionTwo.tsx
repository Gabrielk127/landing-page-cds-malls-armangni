    ...
    >
      <h2
        className="text-lg text-center font-bold pt-8 text-white
              ...
              "
      >
        O <span className="text-custom-text-title">crédito estruturado</span> é
        a opção mais <span className="text-custom-text-title">viável</span>,{" "}
        <span className="text-custom-text-title">segura</span> e{" "}
        <span className="text-custom-text-title">econômica</span> para quem
        deseja desenvolver{" "}
        <span className="text-custom-text-title">projetos imobiliários</span> e
        garantir um negócio{" "}
        <span className="text-custom-text-title">sólido</span>,{" "}
        <span className="text-custom-text-title">próspero</span> e{" "}
        <span className="text-custom-text-title">lucrativo</span>, para ser
